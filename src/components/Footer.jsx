                ...
                <div id="accesoRedes">
                    <ul className="flex justify-around">
                        <a className="flex items-center" href="https://www.instagram.com/ees7elparaiso_patiosabiertos/" target="_blank"
                            title="Instagram Institución"><img src="/instagram.svg" alt="Instagram Logo"
                        ...
                        <a className="flex items-center" href="https://www.facebook.com/secundariaElParaiso" target="_blank"
                            title="Facebook Institución"><img src="/facebook.svg" alt="Facebook Logo" className="size-9 bg-white m-1 rounded-3xl cursor-pointer lg:hover:scale-105"/></a>
                    </ul>
                </div>
            </footer>
        </div>
